...
(function ($) {
    ...
    //form template
    $.fn.editableform.template = '<form class="form-inline editableform"><div class="control-group">' + 
    '&nbsp;<button type="submit" class="btn hide"><i class="icon-ok icon-white"></i></button>&nbsp;<button type="button" class="btn clearfix hide"><i class="icon-ban-circle"></i></button>' + 
